...
static const char col_gray1[]       = "#170f04";
...
static const Rule rules[] = {
	...
	{ "discord",  NULL,       NULL,       TAG(2),       0,           -1 },
	{ "lpasslogin",NULL,      NULL,       0,            1,           -1 },
	{ "pop-up",   NULL,       NULL,       0,            1,           -1 },
	{ "task_dialog",NULL,     NULL,       0,            1,           -1 },
...
static char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          {.v = "/bin/sh -c true" } },
